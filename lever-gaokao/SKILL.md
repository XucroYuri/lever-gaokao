---
name: lever-gaokao
description: "用于中国高考志愿填报、院校专业选择和入学后规划。适用于根据省份、年份、分数、位次、选科、批次进行问诊、规则核验、候选发现、第一性原理审查、人生杠杆率审计、低估机会/抄底备选/过热风险判断、对抗式审查、冲稳保排序、风险审计、报告/表格输出；也适用于专科、高职、复读、艺体、专项、定向、外部数据源和录取概率模型边界讨论。"
---
...
5. 先判断选择空间，但所有画像都服务人生杠杆率。高分宽选择考生不是免审计，而是更要比较中长期路径、强学科机会成本、入学后节点和热门选项是否处在过热峰值；中位窄选择、压线、本专科临界和几分决定层级的尴尬分段，必须先审计热门城市、热门学校和热门专业的竞争成本。
...
13. 正式报告或志愿表输出前，完成免责声明、信源、候选池 ledger、剔除/降级 ledger、专业组调剂、漏选审计、第一性原理审查和过拟合审计自检，并执行下方“高质量运行与输出质量门”自检清单。
...
高质量运行不是“多读文档”，而是让每一步都可核验、可回溯、可继续推进；高质量输出优质结果不是“看起来完整”，而是让考生和家长能看懂依据、风险和下一步。

### 高质量运行要求

1. 先问诊、再判断。缺少边界信息时，先补问或明确标注“只能粗筛”，不凭空补全考生画像。
2. 先证据、再结论。规则、位次、招生计划、专业组、学费等影响决策的信息必须核验或进入待核验 ledger，不把未核验信息写成事实。
3. 先高召回、后收敛。候选新增要记录来源，剔除/降级要留痕；没有全量官方招生计划时，不得宣称“全量候选池”。
4. 工具前后要闭环。调用查询/校验/表格工具前说明要验证什么，工具后更新候选池、风险等级、待核验 ledger 或假设状态。
5. 不越界承诺。不输出精确录取概率，不把“升格/合并/更名/热门”写成确定收益，不替用户拍板唯一答案。
6. 每轮输出都要能接续。即使资料不足，也要给出当前可做的粗筛、缺失项、待核验信源和下一步动作。

### 高质量输出要求

1. 结论先行。先告诉用户“这意味着什么、建议怎么看”，再给证据和表格。
2. 依据可见。每个关键判断都要有信源、证据等级或“待核验”标记，不能只给结论。
3. 风险可见。每个方案都要说明代价、不确定性、失败成本和风险缓释；正式方案必须包含专业组调剂风险。
4. 可执行。输出要落到具体候选、梯度、待核验事项和入学后动作，不能停在抽象方向。
5. 说人话。优先使用 `references/communication-style.md`，把内部术语翻译成考生和家长能懂的话。
6. 正式报告固定包含：普通话摘要、信息有效期与免责声明、已核验/待核验清单、候选池与剔除记录、第一性原理审查、风险审计和下一步动作。

### 输出前自检清单

在交付任何正式报告、最终志愿表或较完整方案前，逐项自查：

- [ ] 是否回答了用户当前最关心的问题？
- [ ] 是否区分了“已核验事实”“推断/假设”“待核验事项”？
- [ ] 是否给出依据、信源或证据等级？
- [ ] 是否说明风险、代价、失败成本和适用条件？
- [ ] 是否避免伪精确概率和确定性承诺？
- [ ] 是否包含用户硬约束、不可接受项和家庭预算？
- [ ] 是否给出下一步核验或执行动作？
- [ ] 是否用考生和家长能懂的语言表达？
- [ ] 正式报告是否包含免责声明和信息有效期？

若任一关键项缺失，先补齐再交付；无法补齐的，必须明确降级为“粗筛/讨论稿”并说明缺口。
